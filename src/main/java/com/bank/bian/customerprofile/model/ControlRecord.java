package com.bank.bian.customerprofile.model;
...
/**
 * The BIAN control record for this service domain: "Customer Profile Maintenance Agreement".
 *
 ...
 * to its asset type (Customer Profile). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Profile Maintenance Agreement";
